...
## Files
- firmware/day13_mqtt_subscribe.ino - Command handler sketch
- firmware/secrets.template.h - Redacted credentials
- docs/command_schema.md - Command JSON schema and whitelisted commands
- images/ - Serial monitor screenshots for each test case